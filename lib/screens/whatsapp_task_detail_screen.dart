// lib/screens/whatsapp_task_detail_screen.dart
//
// Sprint 22.3 — WhatsApp task detail screen.
//
// Shows a chat-bubble preview of the prepared message, a "Gönder"
// button that opens WhatsApp via the
// `https://wa.me/?text=<encoded>` click-to-chat web URL
// (primary path; the `intent://` Android Intent URI is the
// fallback — see `whatsapp_deeplink_provider.dart` for the
// 2-tier rationale), and an "İptal" button that pops back to
// the home screen.
//
// S25 invariant: no "VPN" framing in the UI. Just heading,
// message preview, and the deep link button.
